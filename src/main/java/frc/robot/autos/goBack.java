...
public class goBack extends SequentialCommandGroup {
    
    public goBack(Swerve s_Swerve, Arm s_Arm, PenomaticSubsystem penomaticSubsystem){
        
        PathPlannerTrajectory examplePath = PathPlanner.loadPath("goBack", new PathConstraints(2, 2));
